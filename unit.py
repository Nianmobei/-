...
UNIT_TEMPLATES = {
	...
	# 2级
	"盾卫":   dict(faction=FACTION_RED, level=2, max_hp=6, atk=2, spd=1, trait="铁壁",  ranged=False, can_make=False),
	...
	# ── 灾兽 ──────────────────────────────────────
	# 1级
	"散兽":   dict(faction=FACTION_DIS, level=1, max_hp=3, atk=2, spd=1, trait="招灾",  ranged=False, can_make=False),
	# 2级
	"甲兽":   dict(faction=FACTION_DIS, level=2, max_hp=6, atk=2, spd=1, trait="硬壳",  ranged=False, can_make=False),
